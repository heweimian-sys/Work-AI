    ...
    function: {
      ...
      parameters: {
        ...
        properties: {
          ...
          mode: { type: 'string', enum: ['manual_chapters'], description: '可选。填 manual_chapters 时按“航海列表→章节列表→章节详情”同步航海手册' },
          activityLimit: { type: 'number', description: 'manual_chapters 模式下最多处理多少个航海，默认 3', default: 3 },
          chapterLimit: { type: 'number', description: 'manual_chapters 模式下每个航海最多处理多少个章节，默认 10', default: 10 },
